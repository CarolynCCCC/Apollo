...
import { createRoom, getRoom, joinRoom, getAvailableRooms, leaveRoom, deleteRoom } from '../controller/roomController';
...
router.post(API_ROUTES.ROOMS, getAvailableRooms);
